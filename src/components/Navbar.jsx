  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-slate-900/80 backdrop-blur-md border-b border-white/10">
      <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
        ...
        <button
          type="button"
          className="hidden md:block bg-linear-to-r from-indigo-500 to-purple-500 text-slate-50 text-base font-semibold px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105 hover:brightness-110 hover:shadow-lg hover:shadow-purple-500/50"
        >
          Get Started
        </button>
